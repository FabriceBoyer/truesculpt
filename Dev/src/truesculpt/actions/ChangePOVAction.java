...
public class ChangePOVAction extends BaseAction
{
	...
	public ChangePOVAction(float init_rotation, float init_elevation, float init_zoomDistance,
			float curr_rotation, float curr_elevation, float curr_zoomDistance)
	{
		...
		String strDescription = "Offset [ " + Float.toString(rotOffset)+ 
		" ; " + Float.toString(elvOffset) + 
		" ; " + Float.toString(zoomOffset)+ " ] ";
